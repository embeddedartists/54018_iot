...
static void I2C_WriteRegister(char wrAddr, char wrData) {
  ...
  //I2C1_Write(BME280_I2C_ADDRESS1, tmp_data,2, END_MODE_STOP);
	i2c_handler_take();
	i2c_handler_write(BME280_I2C_ADDRESS1, tmp_data, 2);
	i2c_handler_give();
}
...
static char I2C_ReadRegister(char rAddr) {
  ...
  //I2C1_Read(BME280_I2C_ADDRESS1, tmp_data,1, END_MODE_STOP);
	i2c_handler_take();
	i2c_handler_write(BME280_I2C_ADDRESS1, tmp_data, 1);
	i2c_handler_read(BME280_I2C_ADDRESS1, tmp_data, 1);
	i2c_handler_give();
  return tmp_data[0];
}
...
void BME280_ReadMeasurements() {
  ...
  //I2C1_Read(BME280_I2C_ADDRESS1, tmp_data, BME280_DATA_FRAME_SIZE , END_MODE_STOP);
	i2c_handler_take();
	i2c_handler_write(BME280_I2C_ADDRESS1, tmp_data, 1);
	i2c_handler_read(BME280_I2C_ADDRESS1, tmp_data, BME280_DATA_FRAME_SIZE);
	i2c_handler_give();
