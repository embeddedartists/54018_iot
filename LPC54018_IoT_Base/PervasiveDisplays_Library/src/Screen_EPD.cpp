...
#define bitSet(__tgt, __bit)  ((__tgt) |= (1<<(__bit)))
#define bitClear(__tgt, __bit)  ((__tgt) &= ~(1<<(__bit)))


// Corresponds to _sizeBuffer * _depthBuffer
static uint8_t _staticOldFrameBuffer[296 * (152/8) * 2];
static uint8_t _staticNewFrameBuffer[296 * (152/8) * 2];
...
void Screen_EPD::begin()
{
    ...
    if (!_flagBeginDone)
    {
        ...
        _oldImage = (uint8_t *) _staticOldFrameBuffer;
        _newImage = (uint8_t *) _staticNewFrameBuffer;
    }

    memset(_newImage, 0x00, _sizeBuffer * _depthBuffer);
    memset(_oldImage, 0x00, _sizeBuffer * _depthBuffer);
    ...
    switch (_eScreen)
    {
        ...
        case eScreen_EPD_iTC_266_BWR:
            ...
            _result = _pdi_epd.begin(dr_iTC_Drivers, EPD_266_BWR, USE_Temperature_Sensor);
            break;
    ...
    switch (_eScreen)
    {
        ...
        case eScreen_EPD_eTC_271_Mb:
            ...
            if ((colour == greyColour) or (colour == grayColour))
            {
                ...
                {
									uint16_t pattern = (i % 2) ? 0xaa : 0x55;//0b10101010 : 0b01010101;
